...
- [ ] **GAP-1:** Add bottomless chasm terrain: near-black/dark-gray void, a readable upper rim and recessed perspective face. Unsupported actors and objects fall and are lost/die; define true flight/hover support separately from water flotation. Integrate ordinary steps, shoves, airborne travel/landing, drops, projectiles, bridge failure and deterministic co-op. Falling presentation must agree with the real location; ground enemies should not blindly path into holes.
