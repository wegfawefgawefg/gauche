...
Forest item slice: thirty-seven regional items now have shared definitions,
...
root prevents sleep, chili speeds steps then burns, fungal bread heals then sleeps; snares root, springs shove, acorn mines chain.
...
Matching drops/bait/caltrops are integrated. Horns shove; hooks reel; drills bore terrain; traveling swap seeds exchange actors.
