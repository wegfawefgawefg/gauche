...
- [ ] Implement, asset, sound, test, and playtest the ice catalog.
  Twelve cold room roles host seventeen enemy types, including [keepers](history/ICE_KEEPERS.md),
  [Pilgrims](history/ICE_PILGRIM.md), Lens Wardens and [Echo Hounds](history/ICE_HEARING.md). Twenty-seven items include
  [observatory optics](history/ICE_OPTICS.md). Seventeen of twenty enemy behaviors, twenty-seven of fifty items; [recoverable candles](history/ICE_CANDLES.md) add fuel, warmth and wick supplies.
