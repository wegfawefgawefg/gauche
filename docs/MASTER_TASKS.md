...
- [ ] **CHAPEL-1:** Fix/audit candle ignition from actual fire and fire-damage paths, including fueled extinguished versus spent/wet candles. Verify flame spread/nearby heat handling and resulting light/sound without autonomous playtesting.
- [ ] **CHAPEL-2:** Furnish ordinary Ice chapels with pews, altar/candle stands, wax, broken furnishings, religious/decorative objects and contextual breakables. Add layout variants, aisle/access rules, useful contents and fire/material interactions; four candles plus a keeper is not a finished chapel.
