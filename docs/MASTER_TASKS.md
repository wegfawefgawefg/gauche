...
- [ ] **GEN-FRACTIONAL-ZOOM:** Investigate tile seams visible in SDL software inspector captures at fractional zoom (0.8/0.85). Preserve crisp sprites while making adjacent terrain cover the viewport continuously; verify the actual viewer rendering path.
