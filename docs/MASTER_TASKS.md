...
- [ ] Implement, asset, sound, test, and playtest the ice catalog.
  Seven cold room roles now host seven enemy types, including exposed/
  burrowing Snow Burrowers. Sixteen regional items now include
  [observatory optics](history/ICE_OPTICS.md). Seven of twenty enemies, sixteen of fifty items; balance remains for playtesting.
