...
Forest item slice: twenty-seven regional items now have shared definitions,
...
root prevents sleep, chili speeds steps then burns, fungal bread heals then sleeps; cards/timers explain effects.
...
Seed/glue/claw/lantern/root drops now match their enemies; bird seed and snail loot remain.
