...
- [ ] **GEN-BEAR-DEN:** Compose connected-den terrain as well as population: vary stream paths, sheltered bed clusters and connecting banks without losing ordinary route sockets. Population now independently rolls families/adults/old solitary bears, finite fish/fishers, 2–3 active approach packs, native supplies and scattered remains/vegetation; removed the fixed honey/meat bundle. Quiet residents do not replace approach combat. Build, 32-floor routes/locks/capture/snapshot checks and capacity fixtures passed (9 dens, 19 packs, 69 direct fighters); three inspector previews checked. Same 64-floor comparison retains all non-den floors and raises average direct fighters on every stage. Terrain composition and human combat/variety acceptance remain open.
