...
- [ ] Prototype shared stylized height/contact shadows independent of lights, with debug toggle/static comparisons: creatures, flight, falls and generous small-debris coverage including sticks/selected leaves/casings. Choose by appearance, exclude footprints/flat stains, retain visibility/layering and distinguish landing warnings; measure actual cost if relevant rather than preemptively limiting tiny sprites.
...
- [ ] Implement, asset, sound, test, and playtest the industrial / mine / lava
  ...
  Six catalog enemy behaviors and eight of fifty regional items implemented;
