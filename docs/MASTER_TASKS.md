...
Forest item slice: twenty-two regional items now have shared definitions,
...
eggs, fried at campfires. Seed bags grow cover; lantern seeds make moth lures; claws dig; resin repairs condition.
...
Seed/glue/claw/lantern drops now match their enemies; bird seed, bitter root and snail loot remain.
