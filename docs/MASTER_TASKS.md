...
- [ ] **GEN-SOCKETS:** Replace the unconditional three-cell central cross in every ordinary room with protected paths to its actual incoming/outgoing sockets and objectives. Leave interior areas for shaped terrain and component placement; validate connectivity after overlays rather than erasing every shape with the same plus sign.
