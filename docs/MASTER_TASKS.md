...
Forest item slice: forty regional items now have shared definitions,
...
Oil slips walkers one extra cell; natural sap sources remain. Toads drop spores; nests yield stackable
