...
Forest item slice: forty-eight regional items now have shared definitions,
...
Scarecrows ward birds/rabbits; lanterns light/guard; pans return frontal shots. Oil slips; stink/rot lure scavengers; nausea washes off; delayed pitch burns then leaves resin. Natural sap sources remain. Nests yield stackable
