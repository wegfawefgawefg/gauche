...
Forest item slice: forty-seven regional items now have shared definitions,
...
Shield lanterns light/guard; pans return frontal shots with timed parries. Oil slips; stink/rot lure scavengers; nausea washes off; delayed pitch burns then leaves resin. Natural sap sources remain. Nests yield stackable
