...
Keep new progress updates brief in the master checklist and commits. Put behavior
and shared-state explanations beside the source. Feature write-ups are reference
material, not a required document for each change.
