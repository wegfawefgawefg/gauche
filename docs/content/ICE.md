...
| 18 | Echo hound | Implemented: 44 HP, nine-tick steps; commits to a heard cell for up to 3s, warns 0.4s before a 14-damage bite, then listens again. Snow quiets steps; water amplifies them. Stillness and thrown noise can fool it. | Echo tunnels; 25% raw meat implemented. 10% muffling felt awaits that item. |
