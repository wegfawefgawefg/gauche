...
| 4 | Ice mason | Implemented: 60 HP; places carried 35-HP cover after 0.5s, cuts replacement ice for 1.5s, and defends with a 0.4s jab for 12 damage. Damage, sleep, stun or displacement interrupts work. | Quarry; 20% ice brick, 15% chisel, 25% 2–4 gold, 10% ice anchor, one roll. |
...
| 20 | Pressure valve | Implemented: fit an adjacent tank, locking future vents away from the installer. Existing warning keeps its aim. Recover with pickup while facing a cool idle tank below 25 pressure. | Uncommon; 18; shelter supplies, 10% snow-cache find, rewards/shops. |
...
| 28 | Prism bomb | Implemented: throw to 3 with 1.5s fuse from launch; four range-4 beams, 16 damage each, one shared bounded trace. Mirrors/lenses/knights redirect them. Big extends beams; Long extends throw. Stack 2. | Rare; 28; 10% effigy drop, memorial courts, rewards/shops. |
...
| 40 | Snow shelter | Implemented: two independent 24-HP low walls, ahead and to the right. Both cells must be free/cold/dry. Stops walking, wind, frost, snowballs and flat shots; lobbed bombs/bottles pass over. Heat/brine melts sections to puddles. Two uses; Durable four. | Uncommon; 18; shelter supplies, 10% snow-cache find, rewards/shops. |
...
| 42 | Sled | Implemented: deploy ahead and step aboard. Carries one actual loose item; 4 ticks/cell on snow/ice, 8 on ordinary ground. Steer only stopped; Secondary brakes/dismounts. Walls/bodies stop it; shallow water brakes, deep water/lava block. Recover empty stopped sleds with remaining HP. 45 HP, Durable 90; burns and breaks into wood/rope debris. | Uncommon; 25; travel supplies, 10% fishing creel, Ice shops/rewards |
| 43 | Ice anchor | Implemented: place a 30-HP point on dry ground/ice. Hold Use again to return up to 5 cells, one cell per 3 ticks, wearing 1 HP per step. Cover/bodies stop travel; hazards apply. Secondary recovers within 1 cell without refilling damage. Durable 60 HP; a destroyed/sunk point loses the item. | Rare; 32; 10% mason drop, cliff paths, rewards/shops. |
...
| 46 | Effigy mask | Implemented: hold Use and stand still to watch behind you as well as forward. Both cones obey walls/smoke and seven-cell sight; sides stay blind. 12s total wear, Durable 24s; partial wear persists through trading/stowing. Movement, displacement, sleep and stun interrupt. | Rare; 28; 10% effigy drop, memorial courts, rewards/shops. |
...
| --- | --- | --- |
| Fishing creel | Implemented: 35 smoked fish, 20 line, 15 air bladder, 10 folded bridge, 10 sled, 10 empty; one roll on breaking | Fishing huts; 12 HP, blocking, burnable woven basket |
...
| Snow cache | Implemented: 30 snowball, 20 wool, 15 ammo, 25 gold, 10 snow shelter | Snow mounds; 4 HP, stepping or clearing snow opens once. |
