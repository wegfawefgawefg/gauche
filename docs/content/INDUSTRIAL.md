...
Strikebreaker escorts, Rivet Gunners, Arc Welders, Magnet Cranes, Pressure Rats, Cable Crawlers, Walking Kilns, Audit Clerks, Furnace Moths, Slag Snails, Ash Sleepers, Counterweights, Emergency Pumps, Mold Thieves, Tar Choirs, Rail Shunters, twenty-four regional items, metal cover/bins,
...
| 5 | Rail shunter | Implemented: 120 HP, slow worker; moves behind its real cart, warns with a 0.8s hand bell, then shunts. Cart rolls at eight ticks/cell, stops before its first victim after 18 damage, carries exact cargo and spills it when broken. Cut track, brake/haul cart or interrupt worker with damage/cold/control. Adjacent 12-damage swings warn for 0.6s. Eleven freight/worker cues. | Optional loaded freight siding. One roll: 20% Brake Shoe, next 20% Rail Switch Key pending, next 20% 4–8 gold. Actual cart cargo is separate. |
...
| Rail junction | Initial freight siding implemented; broad T crossing and switch points remain pending | Straight cuttable rail with walkable margins, shunter, real loaded cart and Brake Shoe supply. Cargo is three Bolt Pouch handfuls or a 12-durability Press Hammer. No bodies on the reserved crossing or mandatory gate footprint. See [freight implementation](../history/RAIL_SHUNTER.md). |
...
| Settling tanks | Implemented paired shallow tar basins with a dry central crossing | Three linked singers, cover bins, shoot-through rim grates, Cold Flasks, Emergency Foam and shallow water. Solvent shelf awaits the rag item. See [implementation](../history/TAR_CHOIR.md). |
