...
Strikebreaker escorts, Rivet Gunners, Arc Welders, Magnet Cranes, Pressure Rats, Cable Crawlers, Walking Kilns, Audit Clerks, Furnace Moths, Slag Snails, Ash Sleepers, Counterweights, twenty regional items, metal cover/bins,
...
| Cooling works | Implemented initial variant: finite-fuel boiler and rat across a three-cell lava trench, dry routes around both ends | Coolant Can or water-filled Pocket Pump and ore bin on the dry side; initial coolant spill can be collected after emptying the pump. Protected center and four-cell vent lane stay separate. Shares the maintenance-room selection with repair bays, cable trenches, kiln courts, pay offices, lamp alcoves, slag banks, ash lofts and hoist shafts. Emergency pump/reservoir/nozzle variants remain pending. |
