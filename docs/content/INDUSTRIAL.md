...
Strikebreaker escorts, Rivet Gunners, Arc Welders, Magnet Cranes, Pressure Rats, Cable Crawlers, Walking Kilns, Audit Clerks, Furnace Moths, Slag Snails, Ash Sleepers, Counterweights, Emergency Pumps, Mold Thieves, twenty-four regional items, metal cover/bins,
assembly-room conveyors, wet repair bays, cooling works, cable trenches, kiln courts, pay offices, lamp alcoves, slag banks, ash lofts, hoist shafts, casting floors, scrap-yard sorting lanes, ten integrated catalog debris materials and eight ambient cue families. Track implementation in `../MASTER_TASKS.md`.
...
| 10 | Tar choir | Three 32-HP bodies sway together before coughing sticky, flammable tar at a fixed gap. Break line of sight between singers to stagger their rhythm. Cold clots the patch; fire ignites friends too. Low bubbling thirds, separate coughs. Shared tar material/flask is implemented; singers and coordination remain pending. | Settling tanks; final body only: 30% tar flask, 15% solvent rag. |
