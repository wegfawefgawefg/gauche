...
| Cooling works | Implemented initial variant: finite-fuel boiler and rat across a three-cell lava trench, dry routes around both ends | Coolant Can and ore bin on the dry side; initial coolant spill. Protected center and four-cell vent lane stay separate. Shares the maintenance-room selection with repair bays, cable trenches and kiln courts. Emergency pump/reservoir/nozzle variants remain pending. |
