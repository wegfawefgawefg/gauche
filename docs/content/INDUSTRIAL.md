...
Strikebreaker escorts, Rivet Gunners, Arc Welders, Magnet Cranes, Pressure Rats, Cable Crawlers, Walking Kilns, Audit Clerks, Furnace Moths, Slag Snails, Ash Sleepers, eighteen regional items, metal cover/bins,
assembly-room conveyors, wet repair bays, cooling works, cable trenches, kiln courts, pay offices, lamp alcoves, slag banks, ash lofts, scrap-yard sorting lanes, ten integrated catalog debris materials and eight ambient cue families. Track implementation in `../MASTER_TASKS.md`.
...
| 14 | Ash sleeper | Implemented: 44 HP mound; loud audible work or damage starts a 0.5s shaking rise. Swirling pursuit commits an 0.5s fixed-cell swipe for 8, then 0.5s recovery. Damage/displacement/control interrupt strikes. Six seconds without new agitation settles it; water/cold settles and suppresses waking for 2s without healing. Five dry-grit sounds, two poses. | Optional ash loft with manually cranked belt, Nail Board cargo, coolant and bins; incidental encounters cost 2. Ash-sack/filter-mask drop ranges remain empty until those items exist. Fans remain future content. |
...
| 16 | Cable crawler | Implemented: 50 HP; wall-biased cardinal crawl, eight lifetime wire cells. Braces 0.8s, then pulses at a committed adjacent contact or through its current six-step circuit; 14 contact damage falls with wire/water distance. Own electrode insulated, other electricity still hurts. Rebuilds circuit at firing: cuts and ready grounding spikes work immediately. Cold, displacement, root/control and hits of at least 8 cancel; 1.5s recovery. Two poses, relay charge, snap, claw steps and broken-spool sounds. | Optional cable trench with five-cell wiring, wet branch, dry margins, diggable rock shelf, scrap bin and loose grounding spike; incidental Industrial encounters, cost 2. One roll: 25% Copper Wire; insulated-boots range remains empty until implemented. |
...
| 5 | Chain hook | Implemented: physical five-cell cast, then held hauling every ten ticks. Moves whole loose crates/pots/bins, actual ground gear, and loaded/ridden sleds. Fixed walls/structures pull the user; grounded hazards still apply. Release pauses, secondary cuts, four-second line limit. Blocked or displaced targets cut safely without crushing/rerolling. 24 casts; Long/Durable supported. Five iron-chain sounds. | U / 22; native stage-one stock, scrap-yard supply and 20% scrap-bin drop |
...
| --- | --- | --- |
| Lamp room | Implemented initial optional alcove: offset dry lighting station, protected central route | Two Furnace Moths (one cold), a stove with 30s real fuel, a cold electric Beam Lamp and two Emergency Foam cans. Whole-footprint checks; shares maintenance selection. Safe-entry/water-tap variant remains pending. |
...
| Cooling works | Implemented initial variant: finite-fuel boiler and rat across a three-cell lava trench, dry routes around both ends | Coolant Can and ore bin on the dry side; initial coolant spill. Protected center and four-cell vent lane stay separate. Shares the maintenance-room selection with repair bays, cable trenches, kiln courts, pay offices, lamp alcoves, slag banks and ash lofts. Emergency pump/reservoir/nozzle variants remain pending. |
