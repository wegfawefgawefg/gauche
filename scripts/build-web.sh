...
emcmake cmake -S "$repo_root" -B "$repo_root/build-web" -G Ninja -DCMAKE_BUILD_TYPE=Release -DTEEMING_WARN_AS_ERROR=OFF
cmake --build "$repo_root/build-web" --target teeming --parallel "$CMAKE_BUILD_PARALLEL_LEVEL"
