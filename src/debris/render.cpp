...
constexpr std::array<Sprite, static_cast<std::size_t>(DebrisKind::Count)> sprites{
    ...
    Sprite::DebrisBasaltChip, Sprite::DebrisOreFlake, Sprite::DebrisSteelWasher, Sprite::DebrisTinCurl, Sprite::DebrisRivetCasing, Sprite::DebrisBeltRubber, Sprite::DebrisBentNail, Sprite::DebrisChainLink,
};
}
