...
void init_entity(Game& game, Entity& entity) {
    ...
    case EntityKind::Bat: case EntityKind::FrostBat: case EntityKind::Wolf:
    case EntityKind::Bear: case EntityKind::Bunny: case EntityKind::Ember:
        init_wildlife(game, entity); break;
