...
bool curious(EntityKind kind) {
    switch (kind) {
    case EntityKind::WhiteoutDrummer: case EntityKind::FishingWidow: case EntityKind::FrozenPilgrim: case EntityKind::EchoHound: case EntityKind::Wolf: case EntityKind::Bear: case EntityKind::Boar:
