...
enum class RoofKind : std::uint8_t { Log, IceArch, Gantry, Container, Count };
...
void generate_world_floor(Game& game, FloorLayout layout = FloorLayout::Automatic, PopulationReport* report=nullptr);
