...
enum class ItemKind : std::uint8_t {
    ...
    ForemanWhistle, QuarryCharge, FuseScissors, PressHammer, RubberMallet, RivetGun, BeltCrank, BrakeShoe, ArcTorch, HorseshoeMagnet, FoldingBarricade, CoolantCan, PocketDrill, TensionSpring, EmergencyFoam, BoltPouch,
    Count,
};
