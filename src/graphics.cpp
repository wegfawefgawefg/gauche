...
constexpr std::array<std::string_view, static_cast<std::size_t>(Sprite::Count)> sprite_names{
    ...
    "storm_lantern", "lantern_open", "lantern_focused", "echo_pebble", "echo_pebble_ready", "harpoon_gun", "harpoon_head", "emergency_doorstop", "sluice_gate", "sluice_open", "borrowed_summer", "summer_mote", "heat_siphon", "siphon_charged",
};
