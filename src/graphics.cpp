...
constexpr std::array<std::string_view, static_cast<std::size_t>(Sprite::Count)> sprite_names{
    ...
    "roof_log_a", "roof_log_b", "roof_log_c", "roof_log_end_a", "roof_log_end_b", "roof_log_end_c", "roof_frozen_log_a", "roof_frozen_log_b", "roof_frozen_log_c", "roof_frozen_log_end_a", "roof_frozen_log_end_b", "roof_frozen_log_end_c", "roof_gantry_a", "roof_gantry_b", "roof_gantry_c", "roof_gantry_end_a", "roof_gantry_end_b", "roof_gantry_end_c",
    ...
    "bear_bed", "bone_pile",
    "river_fish", "bear_fish_watch", "bear_fish_paw", "bear_fish_swat", "bear_fish_eat",
    "bear_cub", "bear_mother", "bear_father", "bear_old",
    "ice_spikes_a", "ice_spikes_b", "ice_spikes_c", "snow_pile_a", "snow_pile_b", "snow_pile_c",
    "ice_pillar_forked", "ice_pillar_forked_cracked", "ice_pillar_broad", "ice_pillar_broad_cracked",
    ...
    "ant", "ant_walk", "ant_tell", "ant_bite", "ant_carry", "ant_captain", "ant_captain_walk", "ant_captain_tell", "ant_captain_bite", "ant_captain_carry", "ant_nest", "ant_sugar", "ant_sugar_low", "ant_sugar_empty", "ant_puller", "ant_puller_walk", "ant_puller_tell", "ant_puller_bite", "ant_puller_carry", "ant_load", "ant_load_full",
