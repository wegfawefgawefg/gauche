...
constexpr std::array<std::string_view, static_cast<std::size_t>(Sprite::Count)> sprite_names{
    ...
    "ant", "ant_walk", "ant_tell", "ant_bite", "ant_carry", "ant_captain", "ant_captain_walk", "ant_captain_tell", "ant_captain_bite", "ant_captain_carry", "ant_nest", "ant_sugar", "ant_sugar_low", "ant_sugar_empty",
