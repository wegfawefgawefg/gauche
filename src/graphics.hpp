...
enum class Sprite : std::size_t {
    ...
    IceHole, BellDiver, DiverBubbles, DiverBell, DiverRise, DiverSwing, DiverSink, AirBladder, ItemFloat, ColdFlask, FrozenWater, ThawingWater, HeatCapsule, SteamLeech, LeechLatch, LeechFeed, LeechSwell, LeechSpent, SteamPuff, WoolWrap, HotBroth, IcePoultice, IceMason, MasonCarry, MasonCut, MasonBuild, MasonJab, IceBlock, IceBlockThaw, DebrisIceChip, Chisel, GlassEel, EelCharge, EelSpent, EelStranded, EelBattery, SnowBurrower, SnowMound, SnowWarn, SnowDive, SnowScoop, Snowball, SnowCache, DebrisSnowClump, LensCarbine, MirrorShard, CrystalLens, DebrisMirrorChip, DebrisCrystalSplinter, MirrorKnight, KnightRaise, KnightGuard, KnightSwing, KnightRecover, KnightShield, KnightShieldLit, PrismBomb, PrismBombLit, PrismBombReady,
    Count,
};
