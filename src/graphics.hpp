...
enum class Sprite : std::size_t {
    ...
    StormLantern, LanternOpen, LanternFocused, EchoPebble, EchoPebbleReady, HarpoonGun, HarpoonHead, EmergencyDoorstop, SluiceGate, SluiceOpen, BorrowedSummer, SummerMote, HeatSiphon, SiphonCharged, ThawCharge, ThawChargeLit, ThawChargeReady,
    Count,
};
