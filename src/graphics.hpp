...
enum class Sprite : std::size_t {
    ...
    IceHole, BellDiver, DiverBubbles, DiverBell, DiverRise, DiverSwing, DiverSink, AirBladder, ItemFloat, ColdFlask, FrozenWater, ThawingWater, HeatCapsule, SteamLeech, LeechLatch, LeechFeed, LeechSwell, LeechSpent, SteamPuff,
    Count,
};
