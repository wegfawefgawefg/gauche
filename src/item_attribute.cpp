...
bool item_accepts_attribute(ItemKind kind, ItemAttribute attribute) {
    if (kind == ItemKind::GroundingSpike) return attribute == ItemAttribute::None;
