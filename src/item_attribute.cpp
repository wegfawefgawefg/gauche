...
bool item_accepts_attribute(ItemKind kind, ItemAttribute attribute) {
    ...
    case ItemAttribute::Long: return kind == ItemKind::Firecracker || (weapon && kind != ItemKind::AcornMine) || kind == ItemKind::RopeHook || kind == ItemKind::SwapSeed || kind == ItemKind::ThrowingNet;
