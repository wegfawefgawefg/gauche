...
bool item_accepts_attribute(ItemKind kind, ItemAttribute attribute) {
    ...
    case ItemAttribute::Long: return kind == ItemKind::FishingLine || kind == ItemKind::ColdFlask || kind == ItemKind::WolfWhistle || kind == ItemKind::Firecracker || kind == ItemKind::StinkBomb || kind == ItemKind::RottenFruit || (weapon && kind != ItemKind::AcornMine && kind != ItemKind::EelBattery) || kind == ItemKind::RopeHook || kind == ItemKind::SwapSeed || kind == ItemKind::ThrowingNet;
