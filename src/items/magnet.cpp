...
bool magnetic_item(ItemKind kind) {
    ...
    case ItemKind::MoldKey: case ItemKind::NozzleElbow: case ItemKind::ChainHook: case ItemKind::BoltPouch: case ItemKind::EmergencyFoam: case ItemKind::TensionSpring: case ItemKind::PocketDrill: case ItemKind::CoolantCan: case ItemKind::FoldingBarricade: case ItemKind::BeltCrank: case ItemKind::HorseshoeMagnet: return true;
