...
Entity read_entity(PacketReader& reader) {
    ...
    if (entity.kind==EntityKind::OldGrowthBear && (entity.label_a<0 || entity.label_a>5 || entity.counter_a<0 || entity.counter_a>7)) reader.okay=false;
    if (entity.kind==EntityKind::Gnome && (entity.counter_a<0 || entity.counter_a>3 || entity.counter_b<0 || entity.counter_b>6 || entity.label_a<0 || entity.label_a>4)) reader.okay=false;
    if (entity.kind==EntityKind::GnomeHouse && (entity.counter_a<0 || entity.counter_a>2)) reader.okay=false;
    ...
    if (!valid_fishing_widow(entity) || !valid_bear(entity)) reader.okay=false;
