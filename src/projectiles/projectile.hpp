...
enum class ProjectileKind { Arrow, Bomb, Flask, Rocket, Hook, Drill, Blink, Rock, Boomerang, Net, Firecracker, Mixture, ThunderAcorn, FrostPuff, IceBrick, Snowball, PrismBomb, FishingHook, WidowHook, Flare, EchoPebble, Harpoon, ThawCharge, CoalSpit, QuarryCharge, FoamCan, ThrownBolt, ChainHook };
