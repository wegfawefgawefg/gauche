...
enum class ProjectileKind { Arrow, Bomb, Flask, Rocket, Hook, Drill, Swap, Rock, Boomerang, Net, Firecracker, Mixture, ThunderAcorn, FrostPuff, IceBrick, Snowball, PrismBomb, FishingHook };
