...
enum class SoundId : std::size_t {
    ...
    BumpWood, BumpStone,
    CookingSizzle, WaterStep1, WaterStep2, WaterDouse, MeatMunch, ChickenPeck, BowDraw, BowRelease, ArrowImpact, BombThrow, BombLand, BombFuse,
    Count,
};
...
inline constexpr std::array<std::string_view, static_cast<std::size_t>(SoundId::Count)> sound_names{
    ...
    "bump_wood", "bump_stone", "cooking_sizzle", "water_step1", "water_step2", "water_douse", "meat_munch", "chicken_peck", "bow_draw", "bow_release", "arrow_impact", "bomb_throw", "bomb_land", "bomb_fuse",
};
