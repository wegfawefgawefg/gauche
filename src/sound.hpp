...
enum class SoundId : std::size_t {
    ...
    LanternRaise, LanternBlock, LanternBreak, PanRaise, PanReflect, PanBreak, ScarecrowPlant, ScarecrowTear, DecoyPlant, DecoyHit, DecoyTear, WolfWhistle, WolfAnswer, ThunderThrow, ThunderCrack,
    Count,
};
...
inline constexpr std::array<std::string_view, static_cast<std::size_t>(SoundId::Count)> sound_names{
    ...
    "lantern_raise", "lantern_block", "lantern_break", "pan_raise", "pan_reflect", "pan_break", "scarecrow_plant", "scarecrow_tear", "decoy_plant", "decoy_hit", "decoy_tear", "wolf_whistle", "wolf_answer", "thunder_throw", "thunder_crack",
};
