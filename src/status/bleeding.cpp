...
bool can_bleed(EntityKind kind) {
    ...
    case EntityKind::Gnome: case EntityKind::Ant: case EntityKind::Snake: case EntityKind::ForestSpider: case EntityKind::Bat: case EntityKind::Wolf: case EntityKind::Dog:
    case EntityKind::OldGrowthBear: case EntityKind::Bear: case EntityKind::Boar: case EntityKind::SporeToad:
