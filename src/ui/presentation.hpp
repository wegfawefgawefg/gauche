...
void draw_item_range_base(SDL_Renderer* renderer, const Entity& player, ViewCamera camera, float zoom);
void draw_item_range_top(SDL_Renderer* renderer, const Entity& player, ViewCamera camera, float zoom,
