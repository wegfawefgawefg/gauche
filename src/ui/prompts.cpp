...
float draw_prompt(tr::Renderer* renderer, float x, float y, const InputPrompt& prompt) {
    ...
    tr::set_color_bytes(renderer, 3, 5, 4, 255); tr::fill_rect(renderer, &shadow);
    tr::set_color_bytes(renderer, 45, 49, 45, 255); tr::fill_rect(renderer, &face);
