...
void room_loot(Game& game, const RoomPlan& room, Supplies& budget) {
    ...
    case RoomRole::Cache: {
        constexpr ItemKind equipment[]{ItemKind::Bow, ItemKind::Musket, ItemKind::Buckler,
            ...
            ItemKind::SmokePot, ItemKind::HoneyPot, ItemKind::HuntingHorn, ItemKind::Boomerang, ItemKind::SpringTrap, ItemKind::AcornMine, ItemKind::StinkBomb, ItemKind::RottenFruit, ItemKind::PitchBomb, ItemKind::ShieldLantern, ItemKind::ReflectingPan, ItemKind::HandBell, ItemKind::Firecracker, ItemKind::ThrowingNet, ItemKind::StickyBoots};
