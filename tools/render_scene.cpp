...
int main(int argc, char** argv) {
    ...
    if (mode == "drummers" || mode == "whiteout" || mode == "globe-items") arrange_whiteout_scene(game, cosmetics, player, mode == "whiteout");
