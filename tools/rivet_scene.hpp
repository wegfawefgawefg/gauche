...
inline void arrange_rivet_scene(Game& game,Cosmetics& cosmetics) {
    ...
    auto& player=*get_entity(game,player_state(game,0).controlled);player.cell={17,14};
    ...
    launch_projectile(game,player_state(game,0).controlled.slot,*player.inventory.held(),{1,0},8);
