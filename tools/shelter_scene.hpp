...
inline void arrange_shelter_scene(Game& game,Cosmetics& cosmetics,Entity& player) {
    ...
    place_snow_shelter(game,game.players[0].slot,player.facing);
    ...
    const Cell before=player.cell;player.cell={17,10};place_snow_shelter(game,game.players[0].slot,{0,-1});player.cell=before;
